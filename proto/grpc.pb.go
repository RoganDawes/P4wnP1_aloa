...
var WiFi2WorkingMode_name = map[int32]string{
	0: "UNKNOWN",
	1: "AP",
	2: "STA",
	3: "STA_FAILOVER_AP",
}
var WiFi2WorkingMode_value = map[string]int32{
	"UNKNOWN":         0,
	"AP":              1,
	"STA":             2,
	"STA_FAILOVER_AP": 3,
...
func (x WiFi2WorkingMode) String() string {
	return proto.EnumName(WiFi2WorkingMode_name, int32(x))
}
func (WiFi2WorkingMode) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{0} }

type WiFi2AuthMode int32
...
var WiFi2AuthMode_name = map[int32]string{
	0: "WPA2_PSK",
	1: "OPEN",
}
var WiFi2AuthMode_value = map[string]int32{
	"WPA2_PSK": 0,
	"OPEN":     1,
}

func (x WiFi2AuthMode) String() string {
	return proto.EnumName(WiFi2AuthMode_name, int32(x))
}
func (WiFi2AuthMode) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{1} }
...
type WiFi2Settings struct {
	...
	WorkingMode    WiFi2WorkingMode `protobuf:"varint,4,opt,name=working_mode,json=workingMode,enum=P4wnP1_grpc.WiFi2WorkingMode" json:"working_mode,omitempty"`
	AuthMode       WiFi2AuthMode    `protobuf:"varint,5,opt,name=auth_mode,json=authMode,enum=P4wnP1_grpc.WiFi2AuthMode" json:"auth_mode,omitempty"`
	Channel        uint32           `protobuf:"varint,6,opt,name=channel" json:"channel,omitempty"`
	Ap_BSS         *WiFi2BSSCfg     `protobuf:"bytes,7,opt,name=ap_BSS,json=apBSS" json:"ap_BSS,omitempty"`
	Client_BSSList []*WiFi2BSSCfg   `protobuf:"bytes,8,rep,name=client_BSS_list,json=clientBSSList" json:"client_BSS_list,omitempty"`
...
func (m *WiFi2Settings) Reset()                    { *m = WiFi2Settings{} }
func (m *WiFi2Settings) String() string            { return proto.CompactTextString(m) }
func (*WiFi2Settings) ProtoMessage()               {}
func (*WiFi2Settings) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0} }

func (m *WiFi2Settings) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
func (m *WiFi2Settings) GetDisabled() bool {
	if m != nil {
		return m.Disabled
	}
	return false
...
func (m *WiFi2Settings) GetRegulatory() string {
	if m != nil {
		return m.Regulatory
	}
	return ""
...
func (m *WiFi2Settings) GetWorkingMode() WiFi2WorkingMode {
	if m != nil {
		return m.WorkingMode
	}
	return WiFi2WorkingMode_UNKNOWN
}

func (m *WiFi2Settings) GetAuthMode() WiFi2AuthMode {
	if m != nil {
		return m.AuthMode
	}
	return WiFi2AuthMode_WPA2_PSK
}

func (m *WiFi2Settings) GetChannel() uint32 {
	if m != nil {
		return m.Channel
	}
	return 0
...
func (m *WiFi2Settings) GetAp_BSS() *WiFi2BSSCfg {
	if m != nil {
		return m.Ap_BSS
	}
	return nil
...
func (m *WiFi2Settings) GetClient_BSSList() []*WiFi2BSSCfg {
	if m != nil {
...
func (m *WiFi2Settings) GetHideSsid() bool {
	if m != nil {
		return m.HideSsid
	}
	return false
...
func (m *WiFi2Settings) GetNexmon() bool {
	if m != nil {
		return m.Nexmon
	}
	return false
...
type WiFi2State struct {
	Name        string           `protobuf:"bytes,1,opt,name=name" json:"name,omitempty"`
	Regulatory  string           `protobuf:"bytes,2,opt,name=regulatory" json:"regulatory,omitempty"`
	WorkingMode WiFi2WorkingMode `protobuf:"varint,3,opt,name=working_mode,json=workingMode,enum=P4wnP1_grpc.WiFi2WorkingMode" json:"working_mode,omitempty"`
	AuthMode    WiFi2AuthMode    `protobuf:"varint,4,opt,name=auth_mode,json=authMode,enum=P4wnP1_grpc.WiFi2AuthMode" json:"auth_mode,omitempty"`
	Channel     uint32           `protobuf:"varint,5,opt,name=channel" json:"channel,omitempty"`
	Bss         *WiFi2BSSCfg     `protobuf:"bytes,6,opt,name=bss" json:"bss,omitempty"`
	HideSsid    bool             `protobuf:"varint,7,opt,name=hide_ssid,json=hideSsid" json:"hide_ssid,omitempty"`
	Nexmon      bool             `protobuf:"varint,8,opt,name=nexmon" json:"nexmon,omitempty"`
	Disabled    bool             `protobuf:"varint,9,opt,name=disabled" json:"disabled,omitempty"`
}

func (m *WiFi2State) Reset()                    { *m = WiFi2State{} }
func (m *WiFi2State) String() string            { return proto.CompactTextString(m) }
func (*WiFi2State) ProtoMessage()               {}
func (*WiFi2State) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{1} }

func (m *WiFi2State) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
func (m *WiFi2State) GetRegulatory() string {
	if m != nil {
		return m.Regulatory
	}
	return ""
...
func (m *WiFi2State) GetWorkingMode() WiFi2WorkingMode {
	if m != nil {
		return m.WorkingMode
	}
	return WiFi2WorkingMode_UNKNOWN
...
func (m *WiFi2State) GetAuthMode() WiFi2AuthMode {
	if m != nil {
		return m.AuthMode
	}
	return WiFi2AuthMode_WPA2_PSK
...
func (m *WiFi2State) GetChannel() uint32 {
	if m != nil {
		return m.Channel
	}
	return 0
...
func (m *WiFi2State) GetBss() *WiFi2BSSCfg {
	if m != nil {
		return m.Bss
	}
	return nil
...
func (m *WiFi2State) GetHideSsid() bool {
	if m != nil {
		return m.HideSsid
	}
	return false
...
func (m *WiFi2State) GetNexmon() bool {
	if m != nil {
		return m.Nexmon
	}
	return false
...
func (m *WiFi2State) GetDisabled() bool {
	if m != nil {
		return m.Disabled
	}
	return false
...
func (m *WiFi2BSSCfg) Reset()                    { *m = WiFi2BSSCfg{} }
func (m *WiFi2BSSCfg) String() string            { return proto.CompactTextString(m) }
func (*WiFi2BSSCfg) ProtoMessage()               {}
func (*WiFi2BSSCfg) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{2} }

func (m *WiFi2BSSCfg) GetSSID() string {
	if m != nil {
		return m.SSID
	}
	return ""
...
func (m *WiFi2BSSCfg) GetPSK() string {
	if m != nil {
		return m.PSK
	}
	return ""
...
func init() {
	proto.RegisterType((*WiFi2Settings)(nil), "P4wnP1_grpc.WiFi2Settings")
	proto.RegisterType((*WiFi2State)(nil), "P4wnP1_grpc.WiFi2State")
	proto.RegisterType((*WiFi2BSSCfg)(nil), "P4wnP1_grpc.WiFi2BSSCfg")
	...
	proto.RegisterEnum("P4wnP1_grpc.WiFi2WorkingMode", WiFi2WorkingMode_name, WiFi2WorkingMode_value)
	proto.RegisterEnum("P4wnP1_grpc.WiFi2AuthMode", WiFi2AuthMode_name, WiFi2AuthMode_value)
...
type P4WNP1Client interface {
	...
	DeployWiFiSettings2(ctx context.Context, in *WiFi2Settings, opts ...grpc.CallOption) (*WiFi2State, error)
	GetWiFiState2(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*WiFi2State, error)
	ListenWiFiStateChanges2(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*WiFi2State, error)
}
...
func (c *p4WNP1Client) DeployWiFiSettings2(ctx context.Context, in *WiFi2Settings, opts ...grpc.CallOption) (*WiFi2State, error) {
	out := new(WiFi2State)
	err := grpc.Invoke(ctx, "/P4wnP1_grpc.P4WNP1/DeployWiFiSettings2", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *p4WNP1Client) GetWiFiState2(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*WiFi2State, error) {
	out := new(WiFi2State)
	err := grpc.Invoke(ctx, "/P4wnP1_grpc.P4WNP1/GetWiFiState2", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *p4WNP1Client) ListenWiFiStateChanges2(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*WiFi2State, error) {
	out := new(WiFi2State)
	err := grpc.Invoke(ctx, "/P4wnP1_grpc.P4WNP1/ListenWiFiStateChanges2", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type P4WNP1Server interface {
	...
	DeployWiFiSettings2(context.Context, *WiFi2Settings) (*WiFi2State, error)
	GetWiFiState2(context.Context, *Empty) (*WiFi2State, error)
	ListenWiFiStateChanges2(context.Context, *Empty) (*WiFi2State, error)
}
...
func _P4WNP1_DeployWiFiSettings2_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(WiFi2Settings)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(P4WNP1Server).DeployWiFiSettings2(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/P4wnP1_grpc.P4WNP1/DeployWiFiSettings2",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(P4WNP1Server).DeployWiFiSettings2(ctx, req.(*WiFi2Settings))
	}
	return interceptor(ctx, in, info, handler)
}

func _P4WNP1_GetWiFiState2_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(P4WNP1Server).GetWiFiState2(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/P4wnP1_grpc.P4WNP1/GetWiFiState2",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(P4WNP1Server).GetWiFiState2(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}

func _P4WNP1_ListenWiFiStateChanges2_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(P4WNP1Server).ListenWiFiStateChanges2(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/P4wnP1_grpc.P4WNP1/ListenWiFiStateChanges2",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(P4WNP1Server).ListenWiFiStateChanges2(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _P4WNP1_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DeployWiFiSettings2",
			Handler:    _P4WNP1_DeployWiFiSettings2_Handler,
		},
		{
			MethodName: "GetWiFiState2",
			Handler:    _P4WNP1_GetWiFiState2_Handler,
		},
		{
			MethodName: "ListenWiFiStateChanges2",
			Handler:    _P4WNP1_ListenWiFiStateChanges2_Handler,
		},
	},
...
var fileDescriptor0 = []byte{
	...
	,
}
